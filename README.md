...
```
![image](https://github.com/user-attachments/assets/27323922-b42e-4f1f-95a1-91fcdd15f009)
...
```
![image](https://github.com/user-attachments/assets/ecd8aa82-c2cd-4a92-8d37-a05222107a27)

### **2.3.4 Pantalla de Como usar la app (About-screen.js)**
...
```
![image](https://github.com/user-attachments/assets/1bdfbc26-5833-45bb-9ecd-a38b2fee52dc)
...
```
### **2.4.2 Manejo de Estados de la Aplicación**

#### **Estados Principales:**
```python
// Estados para gestión de datos
const [photo, setPhoto] = useState(null);                    // Imagen capturada
const [predictionResult, setPredictionResult] = useState(null); // Resultado de predicción
const [loading, setLoading] = useState(false);               // Estado de carga
const [error, setError] = useState(null);                    // Manejo de errores
```
### **2.4.3 Procesamiento de Respuestas del Backend**

#### **Estructura de Respuesta Esperada:**
```python
Respuesta del backend: {"detections": [{"bbox": [Array], "class_id": 8, "confidence": 0.9618110060691833, "descripcion": "Para soldar componentes con aire caliente.", "nombre": "Estación de soldadura por aire caliente"}]}

```
![image](https://github.com/user-attachments/assets/4c439444-313d-41ee-acd9-7c2ed969afd1)
...
const processAPIResponse = (response) => {
  if (response.data && response.data.detections && 
    ...
    setPredictionResult({
      ...
      descripcion: detection.descripcion,
    ...
    speakText(`Se detectó ${detection.nombre} con una confianza de ${confidencePercent} por ciento.`);
